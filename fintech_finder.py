...
# YOUR CODE HERE
# selected_account= st.sidebar.selectbox('select an ethereum account',w3.eth.accounts)
account = generate_account()
# account = [account for account in accounts if account.address == selected_account][0]
##########################################

# Write the client's Ethereum account address to the sidebar
# selected_account=st.sidebar.selectbox('Select Ethereum account',[a.address for a in account])
...
# YOUR CODE HERE
st.sidebar.write(f'The total cost to hire {person} for the amount of hours selected -{hours}-, in ethereum is {wage}')
##########################################
# Step 2 - Part 2:
# * Call the `send_transaction` function and pass it three parameters:
    # - Your Ethereum `account` information. (Remember that this `account`
